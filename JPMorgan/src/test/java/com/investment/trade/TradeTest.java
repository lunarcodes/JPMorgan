...
import com.investment.trade.util.TradeDirection;
import com.investment.trade.util.TradeOperation;
...
public class TradeTest {
	...
	public void TradeBuildTest() throws Exception {
		...
		store.collectTrade(constructTrade("5678|2|QED|0|BUY|ACC-2345|CANCEL"));
		...
		calculateTradePosition(store, "ACC-2345|QED|0|5678");
